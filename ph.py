...
def startUp():
    ...
    print("1. After pressing enter, you will have 10 seconds to perform the actions belows")
    print("2. Start logging the paraly SW 112")
    print("3. Place cursor on the bottom row of logs in paraly SW 112 application")
